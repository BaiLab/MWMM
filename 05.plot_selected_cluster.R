...
# 
# 
# # Also list the communities rounds that are possible algorithms run in each cancer.
# communities_round_list <- list()
...
#     communities_round_list[[cancer_type]] <- communities_rounds
# }
...
# We need a function to convert a communities to a bipartite_graph_matrix to plot.


desired_cluster_ordinal <- 113 # or 113 for BP
