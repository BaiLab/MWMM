...
# clusterExport(cl = parallel_cluster, list("a_variable_name", "another_variable_name", envir = environment()))
...
# for (cancer_type in cancer_types) {
    ...
    # The one gene cluster should considered as community similarity as zero.!!!
